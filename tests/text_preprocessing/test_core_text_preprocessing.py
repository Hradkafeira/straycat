...
class TestCoreTextPreprocessing(object):
    ...
    def test_concate_token(self):
        actual = st.concate_token(["saya", "sedang", "memakan", "apple"])
        expected = "saya sedang memakan apple"
        assert actual == expected,MESSAGE
    ...
    def test_stop_words(self):
        ...
        actual2 = st.stop_words("apel yang terlihat lezat",return_type="tokens")
    ...
    def test_normalize_slang(self):
        ...
        actual2 = st.normalize_slang("ak sk mkan", return_type = "tokens")
    ...
    def test_remove_medianame(self):
        ...
        actual2 = st.remove_medianame("kompas.com berita hari ini", return_type = "tokens")
    ...
    def test_remove_link(self):
        ...
        actual2 = st.remove_link("https://www.kompas.com berita hari ini", return_type = "tokens")
        expected2 = ["berita", "hari", "ini"]
    ...
    def test_remove_date(self):
        ...
        actual2 = st.remove_date("tanggal 03 Maret 2020 17/08/1945 10-11-1945 tanggal",return_type="tokens")
    ...
    def test_remove_emoji(self):
        ...
        actual2 = st.remove_emoji("hahaha 😀 😃 😄 hahaha 😁 😆 😅 hahaha", return_type="tokens")
    ...
    def test_remove_punc(self):
        ...
        actual2 = st.remove_punc("dapat hubungi akun@google !!!", return_type="tokens")
    ...
    def test_remove_non_alnum(self):
        ...
        actual2 = st.remove_non_alnum("dapat hubungi akun@google !!!", return_type="tokens")
    ...
    def test_stemming(self):
        ...
        actual2 = st.stemming("saya suka memakan apple", return_type="tokens")
    ...
    def test_case_folding(self):
        ...
        actual2 = st.case_folding("saya suka memakan apple", return_type="tokens")
